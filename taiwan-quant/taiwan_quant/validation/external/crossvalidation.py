# ═══════════════════════════════════════════════════════════════════
# 外部程式碼 — 原封不動保留，請勿在此檔修改
#
# 來源   https://github.com/HKUDS/Vibe-Trading
#        agent/src/quantlib/crossvalidation.py
# commit a5b79422f9f0c6b23512159dfefc8031498df5b8
# 取得日 2026-09-15
# 授權   MIT（見 taiwan_quant/validation/external/LICENSE）
#
# 為什麼原封不動：要升級時可以直接 diff 上游。本專案的用法、限制與
# 手算值測試放在 tests/test_external_validation.py，不改這裡。
#
# ⚠️ purged_kfold_splits 不可使用 — 它會拿測試段之後的資料訓練，
#    違反 CLAUDE.md 禁令 5。詳見該函式自己的 docstring。
# ═══════════════════════════════════════════════════════════════════
